...
set(Qt5QuickControls2_VERSION_STRING 5.9.5)
...
if (NOT TARGET Qt5::QuickControls2)
    ...
    set(Qt5QuickControls2_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickControls2_install_prefix}/include/QtQuickControls2/5.9.5"
        "${_qt5QuickControls2_install_prefix}/include/QtQuickControls2/5.9.5/QtQuickControls2"
    )
    ...
    foreach(_module_dep ${_Qt5QuickControls2_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.5 ${_Qt5QuickControls2_FIND_VERSION_EXACT}
    ...
    _populate_QuickControls2_target_properties(RELEASE "libQt5QuickControls2.so.5.9.5" "" )
