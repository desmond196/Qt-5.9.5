...
set(Qt5DataVisualization_VERSION_STRING 5.9.5)
...
if (NOT TARGET Qt5::DataVisualization)
    ...
    set(Qt5DataVisualization_PRIVATE_INCLUDE_DIRS
        "${_qt5DataVisualization_install_prefix}/include/QtDataVisualization/5.9.5"
        "${_qt5DataVisualization_install_prefix}/include/QtDataVisualization/5.9.5/QtDataVisualization"
    )
    ...
    foreach(_module_dep ${_Qt5DataVisualization_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.5 ${_Qt5DataVisualization_FIND_VERSION_EXACT}
    ...
    _populate_DataVisualization_target_properties(RELEASE "libQt5DataVisualization.so.5.9.5" "" )
